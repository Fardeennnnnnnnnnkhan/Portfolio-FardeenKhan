...
const experiences = [
  {
    ...
    icon: 'https://avatars.githubusercontent.com/u/130365840?s=280&v=4', // Add an icon for Prodigy Infotech if available
    iconBg: "#383E56",
    date: "July 2024 - Present",
    points: [
      "Developed and optimized web interfaces using HTML, CSS, JavaScript, and React.",
      "Collaborated with senior developers to implement responsive and user-friendly designs.",
      "Worked on creating dynamic components and improving website performance.",
      "Debugged and resolved issues across multiple projects to ensure optimal performance.",
    ],
  },
  {
